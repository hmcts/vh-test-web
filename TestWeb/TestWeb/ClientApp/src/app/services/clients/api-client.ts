...
export class ApiClient {
     ...
     * @param request Details of the required allocation
     * @return Full details of an allocated user
     */
    allocateSingleUser(request: AllocateUserRequest): Observable<UserDetailsResponse> {
        ...
        return this.http
            ...
            .pipe(
                _observableMergeMap((response_: any) => {
                    return this.processAllocateSingleUser(response_);
                })
            )
            .pipe(
                _observableCatch((response_: any) => {
                    if (response_ instanceof HttpResponseBase) {
                        try {
                            return this.processAllocateSingleUser(<any>response_);
                        } catch (e) {
                            return <Observable<UserDetailsResponse>>(<any>_observableThrow(e));
                        }
                    } else return <Observable<UserDetailsResponse>>(<any>_observableThrow(response_));
                })
            );
    }

    protected processAllocateSingleUser(response: HttpResponseBase): Observable<UserDetailsResponse> {
     ...
     * @param request Allocate users request
     * @return Full details of an allocated users
     */
    allocateUsers(request: AllocateUsersRequest): Observable<UserDetailsResponse[]> {
            ...
            return blobToText(responseBlob).pipe(
                _observableMergeMap(_responseText => {
                    ...
                    if (Array.isArray(resultData200)) {
                        result200 = [] as any;
                        for (let item of resultData200) result200!.push(UserDetailsResponse.fromJS(item));
                    }
                    return _observableOf(result200);
                })
            );
     ...
     * @param request List of usernames to unallocate
     * @return Allocation details of the unallocated users
     */
    unallocateUsers(request: UnallocateUsersRequest): Observable<AllocationDetailsResponse[]> {
     ...
     * @return Full details of any allocated users
     */
    getAllocatedUsers(username: string | null): Observable<AllocationDetailsResponse[]> {
        ...
        return this.http
            ...
            .pipe(
                _observableMergeMap((response_: any) => {
                    return this.processGetAllocatedUsers(response_);
                })
            )
            .pipe(
                _observableCatch((response_: any) => {
                    if (response_ instanceof HttpResponseBase) {
                        try {
                            return this.processGetAllocatedUsers(<any>response_);
                        } catch (e) {
                            return <Observable<AllocationDetailsResponse[]>>(<any>_observableThrow(e));
                        }
                    } else return <Observable<AllocationDetailsResponse[]>>(<any>_observableThrow(response_));
    ...
    protected processGetAllocatedUsers(response: HttpResponseBase): Observable<AllocationDetailsResponse[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body : (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * Create video event
     * @param request Conference event request
     */
    createVideoEvent(request: ConferenceEventRequest): Observable<void> {
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(
                _observableMergeMap(_responseText => {
                    ...
                    if (Array.isArray(resultData200)) {
                        result200 = [] as any;
                        for (let item of resultData200) result200!.push(ConferenceResponse.fromJS(item));
                    }
                    return _observableOf(result200);
                })
            );
     ...
     * @return Full details of a conference
     */
    getConferenceByHearingRefId(hearingRefId: string): Observable<ConferenceResponse> {
        ...
        if (hearingRefId === undefined || hearingRefId === null) throw new Error("The parameter 'hearingRefId' must be defined.");
     ...
     * @return Error if fails, otherwise OK status
     */
    ...
    /**
     * Create a hearing
     * @param request Details on the new hearing
     * @return Full details of created hearing
     */
    createHearing(request: CreateHearingRequest): Observable<HearingDetailsResponse> {
        ...
        return this.http
            ...
            .pipe(
                _observableMergeMap((response_: any) => {
                    return this.processCreateHearing(response_);
                })
            )
            .pipe(
                _observableCatch((response_: any) => {
                    if (response_ instanceof HttpResponseBase) {
                        try {
                            return this.processCreateHearing(<any>response_);
                        } catch (e) {
    ...
    protected processCreateHearing(response: HttpResponseBase): Observable<HearingDetailsResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body : (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @param request Update the booking status details
     * @return Confirm a hearing
     */
    confirmHearingById(hearingId: string, request: UpdateBookingStatusRequest): Observable<ConferenceDetailsResponse> {
     ...
     * @param request Partial case name or number text for the hearing
     * @return Number of deleted hearings or conferences
     */
    deleteTestDataByPartialCaseText(request: DeleteTestHearingDataRequest): Observable<DeletedResponse> {
        ...
        return this.http
            ...
            .pipe(
                _observableMergeMap((response_: any) => {
                    return this.processDeleteTestDataByPartialCaseText(response_);
                })
            )
            .pipe(
                _observableCatch((response_: any) => {
                    if (response_ instanceof HttpResponseBase) {
                        try {
                            return this.processDeleteTestDataByPartialCaseText(<any>response_);
                        } catch (e) {
                            return <Observable<DeletedResponse>>(<any>_observableThrow(e));
                        }
                    } else return <Observable<DeletedResponse>>(<any>_observableThrow(response_));
                })
            );
    }

    protected processDeleteTestDataByPartialCaseText(response: HttpResponseBase): Observable<DeletedResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body : (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Hearings CreatedBy the user
     */
    ...
    /**
     * Reset user password
     * @param request Details of the user to reset
     * @return Password of the reset user
     */
    resetPassword(request: ResetUserPasswordRequest): Observable<UpdateUserResponse> {
        ...
        return this.http
            ...
            .pipe(
                _observableCatch((response_: any) => {
                    ...
                    } else return <Observable<UpdateUserResponse>>(<any>_observableThrow(response_));
                })
            );
    }

    protected processResetPassword(response: HttpResponseBase): Observable<UpdateUserResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body : (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class HealthCheckResponse implements IHealthCheckResponse {
    test_api_health?: HealthCheck | undefined;
...
export class HealthCheck implements IHealthCheck {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.data = _data['data'] ? IDictionary.fromJS(_data['data']) : <any>undefined;
        }
    }
...
export abstract class IDictionary implements IIDictionary {
    item?: any | undefined;
    keys?: any[];
    values?: any[];
    isReadOnly?: boolean;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data['Keys'])) {
                this.keys = [] as any;
                for (let item of _data['Keys']) this.keys!.push(item);
            }
            ...
            this.isFixedSize = _data['IsFixedSize'];
        }
    }

    static fromJS(data: any): IDictionary {
        data = typeof data === 'object' ? data : {};
        throw new Error("The abstract class 'IDictionary' cannot be instantiated.");
    }
    ...
    toJSON(data?: any) {
        ...
        data['IsFixedSize'] = this.isFixedSize;
        return data;
    }
}

export interface IIDictionary {
    item?: any | undefined;
    keys?: any[];
    values?: any[];
    isReadOnly?: boolean;
...
export class HearingDetailsResponse implements IHearingDetailsResponse {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data['participants'])) {
                this.participants = [] as any;
                for (let item of _data['participants']) this.participants!.push(ParticipantResponse2.fromJS(item));
            }
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data['users'])) {
                this.users = [] as any;
                for (let item of _data['users']) this.users!.push(UserDto.fromJS(item));
            }
...
export class ConferenceDetailsResponse implements IConferenceDetailsResponse {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data['endpoints'])) {
                this.endpoints = [] as any;
                for (let item of _data['endpoints']) this.endpoints!.push(EndpointResponse2.fromJS(item));
            }
